...
insert into specialite values (default,'videur');
insert into specialite values (default,'nettoyeur');
insert into specialite values (default,'mecanicien');
insert into specialite values (default,'garagiste');
